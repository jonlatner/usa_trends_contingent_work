...
global programs $rootdir/programs/sipp01
global dictdir $rootdir/programs/sipp01
global rawdata $rootdir/rawdata/sipp01
global output $rootdir/rawdata/sipp01
...
program define lweights
	...
	global dict_name "$dictdir/sip01lw9.dct"
	global data_name "$rawdata/sipp01lw9.dat"

	quietly infile using $dict_name, using($data_name) clear

	cd $output
	save sipp01lwt.dta, replace
end
