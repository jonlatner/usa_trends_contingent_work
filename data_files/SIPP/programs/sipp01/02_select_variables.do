...
use sipp01w1.dta, clear

foreach i of num 1/9 {		
	use sipp01w`i'.dta, clear
	...
	*Race/ethnicity
	...
	sort id wave srefmon
	save sipp01w`i'_small.dta, replace
}

* Append
set more off
use sipp01w1_small.dta, clear
foreach i of num 2/9 {		
	append using sipp01w`i'_small.dta
	sort id wave srefmon
}

* Merge in longitudinal panel weight
merge m:1 ssuid epppnum using sipp01lwt, keepusing(lgtpnwt*)
keep if _m == 3
...
* Save
save sipp01_append.dta, replace

* Miscellaneous
use sipp01_append.dta, clear
