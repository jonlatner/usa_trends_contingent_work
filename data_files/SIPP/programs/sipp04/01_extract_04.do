...
global programs $rootdir/programs/sipp04
global dictdir $rootdir/programs/sipp04
global rawdata $rootdir/rawdata/sipp04
...
program define lweights
	...
	do sipplgtwgt2004w12.do

	cd $output
	save sipp04lwt.dta, replace
end
