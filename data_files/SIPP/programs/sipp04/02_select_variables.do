...
foreach i of num 1/12 {		
	...
	*Employment
	...
	replace temp_agency = 1 if ejbind1 == 7580 | ejbind2 == 7580
	
	rename ecflag contingent /* LF: Flag indicating other-work-arrange */

	gen temp_work = 0
	replace temp_work = 1 if temp_agency == 1 | contingent == 1
	...
	*Race/ethnicity
	...
	sort id wave srefmon
	save sipp04w`i'_small.dta, replace
}
...
foreach i of num 2/12 {		
	append using sipp04w`i'_small.dta
	sort id wave srefmon
}
