...
File: extract_96.do
Date: August 11, 2003
Desc: This program extracts the 2096 data.
...
This program will read the 2096 SIPP panel into Stata format and label 
...
global programs $rootdir/programs/sipp96
global dictdir $rootdir/programs/sipp96
global rawdata $rootdir/rawdata/sipp96
...
while "`1'"~="" {
	...
	while `i'<13 {	
		...
		global dict_name "$dictdir/sip96l`i'.dct"
		global data_name "$rawdata/sipp96l`i'.dat"
...
program define lweights
	...
	cd $programs
	do sipp1996ctl_fer.do

	cd $output
	save sipp96lwt.dta, replace
end
